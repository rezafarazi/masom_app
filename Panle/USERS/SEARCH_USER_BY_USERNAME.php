...
<center>
    ...
    <div id="USER_PANLE_TABLE">
        ...
        <table dir="rtl" style="margin: 0 auto;" class="USER_TABLE">
            ...
            $SEARCH_VALUE=$_POST['SEARCH_USER'];

            $QUARY=SELECT_BY_QUARY("SELECT * FROM users WHERE user LIKE '%$SEARCH_VALUE%' OR Name LIKE '%$SEARCH_VALUE%' OR Family LIKE '%$SEARCH_VALUE%' OR phone LIKE '%$SEARCH_VALUE%';","user~Name~Family~email~sex~image~enable_flag~permission~id~phone","1");
